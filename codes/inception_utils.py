...
def prepare_inception_metrics(dataset, parallel, no_fid=False):
  ...
  data_mu = np.load('/home/pranav/Desktop/Honors Project SAM Optimizer/Least_action_dynamics_minmax-main/ResNet Code/cifar10stats.npz')['mu']
  data_sigma = np.load('/home/pranav/Desktop/Honors Project SAM Optimizer/Least_action_dynamics_minmax-main/ResNet Code/cifar10stats.npz')['sigma']
